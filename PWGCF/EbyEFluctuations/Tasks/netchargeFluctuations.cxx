...
struct NetchargeFluctuations {
  ...
  Configurable<int> threshold{"threshold", 1e-6, "Delta eta bin count"};
  ...
  Configurable<bool> cCorrectedReco{"cCorrectedReco", true, "Corrected Reco"};
  Configurable<bool> cCorrectedData{"cCorrectedData", false, "Corrected Data"};
